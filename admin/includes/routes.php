...
require_once 'controllers/IndependenceController.php' ;
...
$IndependenceController = new IndependenceController($DatabaseController->getConnectionDB()); // add IndependenceController in (10/01/2024)
