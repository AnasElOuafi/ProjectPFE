    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="accueil" class="nav-link px-2 link-body-emphasis">Accueil</a></li>
          ...
          <li><a href="review" class="nav-link px-2 link-body-emphasis">Commentaire</a></li>
          <li><a href="commentaire" class="nav-link px-2 link-body-emphasis">Evaluation</a></li>
          <li><a href="boit-Mail" class="nav-link px-2 link-body-emphasis">Emails</a></li>
        </ul>
